...
public class Inventory  implements java.io.Serializable {
    ...
    public Inventory(String stockNumber, int year, int catagoryLineId, int makeId, String title, String descript, String newused, Date dateListed, Date dateDeleted, Date createDate, String isActive, String fileList, Integer social) {
